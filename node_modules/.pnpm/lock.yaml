...
importers:
  ...
  .:
    dependencies:
      '@randish/sustain-core':
        specifier: ^0.0.1
        version: 0.0.1
      tsup:
        specifier: ^8.5.0
        version: 8.5.0(tsx@4.20.6)(typescript@5.8.3)
      typescript:
        specifier: ^5.8.3
        version: 5.8.3

  packages/sustain-cli:
    dependencies:
      '@randish/sustain-core':
        specifier: ^0.3.0
        version: 0.3.0
...
packages:
  ...
  '@randish/sustain-core@0.0.1':
    resolution: {integrity: sha512-i/x567PPt7dsRuecEYaRrUid8ov4Z//mXVSBiPzpz5lctbO2MaBN4i1jC1da2HK/HWXU6+xBVLnAMVfGFuAKUA==}

  '@randish/sustain-core@0.3.0':
    resolution: {integrity: sha512-1V+vdR+BolJuucojaEbJhkIa/FQcZJcl6TX/Q7nTIFpE9hKIY0fmrXXBq8jnbDROme/D21qGajpgL4CZTsVuBg==}
    engines: {node: '>=16.0.0'}
...
snapshots:
  ...
  tsup@8.5.0(tsx@4.20.6)(typescript@5.8.3):
    dependencies:
      bundle-require: 5.1.0(esbuild@0.25.8)
      cac: 6.7.14
      chokidar: 4.0.3
